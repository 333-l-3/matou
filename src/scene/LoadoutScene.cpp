...
void LoadoutScene::onEnter() {
    ...
    allPlants.clear();
    allPlants.push_back({"豌豆射手", "res\\images\\Peashooter.png", nullptr});
    allPlants.push_back({"向日葵", "res\\images\\SunFlower.png", nullptr});
    allPlants.push_back({"坚果墙", "res\\images\\WallNut.png", nullptr});
    allPlants.push_back({"土豆雷", "res\\images\\PotatoMine.png", nullptr});
    allPlants.push_back({"寒冰射手", "res\\images\\SnowPea.png", nullptr});
    allPlants.push_back({"樱桃炸弹", "res\\images\\CherryBomb.png", nullptr});
    allPlants.push_back({"双发射手", "res\\images\\Repeater.png", nullptr});
    allPlants.push_back({"胆小菇", "res\\images\\danxiaogu.png", nullptr});
    allPlants.push_back({"胆大菇", "res\\images\\dandagu.png", nullptr});
    allPlants.push_back({"大嘴花", "res\\images\\dazuihua.png", nullptr});
    allPlants.push_back({"维什戴尔", "res\\images\\wsdr.png", nullptr});
